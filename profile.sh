...
! ncu -f --target-processes all --set full \
--import-source on \
-o profile_flash_attn_64_casual python utils/test_flash_fwd_causal.py 4 4096 32 64 1
...
! ncu -f --target-processes all --set full \
--import-source on \
-o profile_flash_attn_128_casual python utils/test_flash_fwd_causal.py 4 4096 32 128 1
