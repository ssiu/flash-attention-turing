...
//     }
    ...
    cudaFuncSetAttribute(compute_dk_dv_kernel_v6, cudaFuncAttributeMaxDynamicSharedMemorySize, maxbytes);
    compute_dk_dv_kernel_v6<<<dimGrid, dimBlock, maxbytes>>>(q_ptr,
                                            k_ptr,
                                            v_ptr,
                                            l_ptr,
                                            d_ptr,
