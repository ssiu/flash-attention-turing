...
//     }
    ...
    cudaFuncSetAttribute(compute_dq_kernel_v4, cudaFuncAttributeMaxDynamicSharedMemorySize, maxbytes);
    compute_dq_kernel_v4<<<dimGrid_dq, dimBlock_dq, maxbytes>>>(q_ptr,
                                            k_ptr,
                                            v_ptr,
                                            l_ptr,
                                            d_ptr,
    ...
    cudaFuncSetAttribute(compute_dk_dv_kernel_v4, cudaFuncAttributeMaxDynamicSharedMemorySize, maxbytes);
    compute_dk_dv_kernel_v4<<<dimGrid, dimBlock, maxbytes>>>(q_ptr,
                                            k_ptr,
                                            v_ptr,
                                            l_ptr,
                                            d_ptr,
